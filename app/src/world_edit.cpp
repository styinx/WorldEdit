...
world_edit::world_edit(const HWND window, utility::command_line command_line)
   : _imgui_context{ImGui::CreateContext(), &ImGui::DestroyContext},
     ...
     _renderer_never_use_shader_barycentrics{
        command_line.get_flag("-gpu_no_shader_barycentrics")},
     _renderer_never_use_conservative_rasterization{
        command_line.get_flag("-gpu_no_conservative_rasterization")},
...
void world_edit::finish_entity_select(const select_method method) noexcept
{
   ...
   if (drag_select) {
      ...
      world::drag_select(
         _world, _world_hit_mask, _world_layers_hit_mask, _object_classes,
...
auto world_edit::get_renderer_init_params() noexcept -> graphics::renderer_init
{
   return {
      ...
      .never_use_shader_barycentrics = _renderer_never_use_shader_barycentrics,
      .never_use_conservative_rasterization = _renderer_never_use_conservative_rasterization,
