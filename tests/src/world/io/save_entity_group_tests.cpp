...
TEST_CASE("world save entity group (blocks, stairways floating)", "[World][IO]")
{
   (void)io::create_directory("temp/entity_groups");
   const io::path path =
      "temp/entity_groups/test_blocks_stairways_floating.eng";
...
TEST_CASE("world save entity group (blocks, cones)", "[World][IO]")
{
   (void)io::create_directory("temp/entity_groups");
   const io::path path = "temp/entity_groups/test_blocks_cones.eng";
...
TEST_CASE("world save entity group (blocks, pyramids)", "[World][IO]")
{
   (void)io::create_directory("temp/entity_groups");
   const io::path path = "temp/entity_groups/test_blocks_pyramids.eng";
...
TEST_CASE("world save entity group (blocks, rings)", "[World][IO]")
{
   (void)io::create_directory("temp/entity_groups");
   const io::path path = "temp/entity_groups/test_blocks_rings.eng";
...
TEST_CASE("world save entity group (blocks, beveled boxes)", "[World][IO]")
{
   (void)io::create_directory("temp/entity_groups");
   const io::path path = "temp/entity_groups/test_blocks_beveled_boxes.eng";
...
TEST_CASE("world save entity group (blocks, curves)", "[World][IO]")
{
   (void)io::create_directory("temp/entity_groups");
   const io::path path = "temp/entity_groups/test_blocks_curves.eng";
